...
const Hero = () => {
  return (
    <section id="inicio" className="relative bg-white overflow-hidden border-b border-gray-900">
          ...
          <main className="mt-10 mx-auto max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
            <div className="sm:text-center lg:text-left">
              <h1 className="text-4xl tracking-tight font-extrabold text-gray-900 sm:text-5xl md:text-6xl">
                ...
                <span className="block bg-gradient-to-r from-blue-500 to-green-500 bg-clip-text text-transparent xl:inline">Seguridad y Salud en el Trabajo</span>
              </h1>
