...
const Chatbot: React.FC = () => {
  ...
  useEffect(() => {
    ...
    if (!chatRoot) {
      ...
      // Estilos críticos para el portal root
      chatRoot.style.position = 'fixed';
      chatRoot.style.top = '0';
      chatRoot.style.left = '0';
      chatRoot.style.width = '100vw';
      chatRoot.style.height = '100vh';
      chatRoot.style.pointerEvents = 'none'; // Permite clicks a través del contenedor
  ...
  const handleWhatsAppRedirect = () => {
    ...
    // Usar location.href como fallback si window.open es bloqueado
          ...
          <div className="mt-3 space-y-2">
            {message.options.map((option, index) => (
              <button
                ...
                className="w-full px-4 py-2.5 bg-white hover:bg-gradient-to-r hover:from-blue-600 hover:to-purple-600 
                         text-gray-700 hover:text-white border-2 border-gray-200 hover:border-transparent 
                         rounded-xl text-sm font-medium transition-all duration-200 transform hover:scale-[1.02] 
  ...
  const chatContent = (
    <>
      ...
      {isOpen && (
        <div 
          className="w-[calc(100vw-3rem)] md:w-[440px] h-[600px] max-h-[calc(100vh-140px)] 
                      bg-white rounded-3xl shadow-2xl flex flex-col overflow-hidden animate-slideUp"
          style={{ 
            position: 'fixed', 
            bottom: '100px', 
            right: '24px', 
        ...
        >
          ...
          <div className="bg-gradient-to-r from-blue-600 to-purple-600 text-white p-5 flex items-center gap-3">
            ...
            <div>
              <h3 className="font-bold text-lg">GESTUS Soluciones</h3>
              <p className="text-sm text-blue-100">Asesoría en SG-SST</p>
            </div>
          </div>
            ...
            {isTyping && (
              <div className="flex justify-start mb-4 animate-fadeIn">
                <div className="max-w-[80%]">
                  <div className="rounded-2xl px-4 py-3 bg-white text-gray-800 shadow-md flex gap-1 items-center">
          ...
          <div className="p-4 bg-white border-t border-gray-100">
            <div className="flex gap-2">
              <textarea
                ...
                className="flex-1 px-4 py-3 border-2 border-gray-200 rounded-xl resize-none focus:outline-none focus:border-blue-500 text-sm"
                rows={1}
              ...
              <button
                ...
                className="px-4 py-3 bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 
                         disabled:opacity-50 disabled:cursor-not-allowed text-white rounded-xl transition-all duration-200 
                         transform hover:scale-[1.02] shadow-md hover:shadow-lg flex items-center justify-center"
              >
            ...
            <button
              ...
              className="w-full mt-3 px-6 py-3 bg-green-500 hover:bg-green-600 text-white rounded-xl 
            ...
            <p className="text-xs text-gray-500 mt-2 text-center">Respuesta en menos de 5 minutos</p>
          </div>
        </div>
      )}
      ...
      <style>{`
        ...
        /* Asegurar que el chatbot esté siempre visible */
        #chatbot-root {
          position: relative;
          z-index: 9999;
        }
